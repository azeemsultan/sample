export const en = {
  ...
  sidebar_users_overview: 'Users Overview',
  sidebar_messages_overview: 'Messages',
  sidebar_blogs_overview: 'Blogs',
  ...
  clients_no_record_found: 'No Records Found',
  ...
  client_single_api_key_unblock_application_button: 'Unblock Application',
  client_single_api_key_generate_api_key_button: 'Generate API Key',
  client_single_api_key_generate_api_key_success: 'API Key is Generated Successfully',
  client_single_api_key_generate_api_limit_error: 'Sorry, we cannot regenerate a new API Key as regenerate limit is reached.',
  client_single_api_key_generate_api_3scale_error: '3Scale API Error. Please contact Administrator.',
  client_single_api_application_suspend_success: '3Scale Application is suspended successfully',
  client_single_api_application_unblock_success: '3Scale Application is Unblocked successfully',
  client_single_api_application_suspend_error: 'Application is already suspended',
  client_single_api_application_unblock_errpr: 'Application is already unblocked',
  client_single_api_key_account_pending_approval: 'Your account is not approved yet. Please contact Administrator for more details.',
  client_single_api_key_account_suspended: 'Your account is suspended. Please contact Administrator for more details.',
  // Clients Form
  three_scale_temporary_password_subject: 'IT22 Admin Panel - 3Scale Account Created',
  clients_form_password_field: 'Password',
  clients_password_required_form_error: 'Password must contain atleast one alphabet of uppercase, number and special character',
};
